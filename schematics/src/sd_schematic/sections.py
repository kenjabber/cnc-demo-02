...
POSITIONS = {
    ...
    "R76":     (2706, 2736),
    "LOCKOUT": (2937, 2664),
    # --- S9_output: the output bridge, J5, and ground-fault sense ---------
    "J5":             (5188, 1039),
    "C51":            (5309, 1321),
    "R157":           (4628, 1783, "R270"),
    "R156":           (4889, 1783, "R270"),
    "R144":           (4948, 1859),
    "R151":           (5057, 1775, "R270"),
    "SURGE_DETECTOR": (5250, 1770),
    "D51":  (3816, 2450), "R150": (3830, 2532), "D50": (3774, 2620),
    "C55":  (4035, 2570, "R270"), "R149": (4119, 2570, "R270"),
    "Q14":  (4197, 2493),
    "D48":  (3774, 2679), "R147": (3830, 2744), "D49": (3816, 2820),
    "C53":  (4035, 2782, "R270"), "R155": (4119, 2782, "R270"),
    "Q12":  (4197, 2702),
    # D78 is drawn as a diamond, so all four legs stand on end: anode low,
    # cathode high for the pair feeding the bus, and the same for the return.
    "D78A": (4493, 2577, "R90"), "D78B": (4698, 2577, "R90"),
    "D78C": (4493, 2688, "R90"), "D78D": (4698, 2688, "R90"),
    "Q9":   (5015, 2500),
    "R135": (5107, 2575, "R270"), "C44": (5234, 2575, "R270"),
    "D47":  (5471, 2443), "R136": (5471, 2532), "D46": (5471, 2620),
    "Q11":  (5015, 2705),
    "R153": (5107, 2782, "R270"), "C52": (5234, 2782, "R270"),
    "D53":  (5471, 2679), "R154": (5471, 2744), "D52": (5471, 2820),
    "RGF":  (4348, 3043), "FGF": (4493, 3043),
